            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea type = "number" class="form-control" style="height:50px" name="salary"
                        placeholder="enter employee's salary"></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>bonus percent:</strong>
                    <textarea type = "number" class="form-control" style="height:50px" name="bonus_percent"
                        placeholder="enter employee's bonus percent"></textarea>
                </div>
            </div>
