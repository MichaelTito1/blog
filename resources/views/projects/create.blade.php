...
@section('content')
    ...
    <form action="{{ route('projects.store') }}" method="POST" >
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Salaries Total:</strong>
                    <input type="text" name="salaries_total" class="form-control" placeholder="salaries_total">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Bonus Total:</strong>
                    <input type="number" name="bonus_total" class="form-control" placeholder="bonus_total">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Payments Total:</strong>
                    <input type="number" name="payments_total" class="form-control" placeholder="payments_total">
                </div>
            </div>
